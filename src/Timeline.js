...
// most of this class doesn't need changes
// the bulk of the work here involves taking the
// jquery and making it work nicely with jupuyterlab
// widgets
...
export default class JobTimeline {
    constructor(cellmonitor) {
        ...
        this.timelineGroups2 = new DataSet([
    ...
    registerRefresher() {
        this.i = 0;
        this.clearRefresher()
        this.flushInterval = setInterval(() => { this.refreshTimeline(); }, 1000);
    }
